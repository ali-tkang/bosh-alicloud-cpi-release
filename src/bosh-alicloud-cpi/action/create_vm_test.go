...
var _ = Describe("create_vm", func() {
	...
	//	Expect(mockContext.Instances).Should(HaveKey(r.Result))
	//})

	//It("can create vm with external-ip", func() {
	//	r := caller.Run([]byte(`{
	//		"method": "create_vm",
	//		"arguments": [
	...
	//})
	//
	//It("can create vm with complex network ", func() {
	//	r := caller.Run([]byte(`{
	//		"method": "create_vm",
	//		"arguments": [
	//			"182a951a-2f8e-4d22-6489-d78b4a8b6f8a",
	...
	//})
	//
	//It("can create vm with epheral disk", func() {
	//	r := caller.Run([]byte(`{
	//		"method": "create_vm",
	//		"arguments": [
	...
	//})
	//
	It("can create vm with cf input", func() {
		in := mock.NewBuilder(`{
    		"method": "create_vm",
			"arguments": [
				...
				{
					"bosh": {
						"password": "$6$261fa655c4a40809$uUwgxAtgHXZqj2a6YXwyaTNWtG0OasmmsMnT5TYOMRmdlMAw2Jb1CeU0Mcstvlsj5u4f793DNcE2ebQF8qIqM1",
						"group": "my-bosh-alicloud-test-compilation-62a025de-2202-41ff-bb1f-ac45fde4d170",
						"groups": [
							"my-bosh",
							"alicloud-test",
							"compilation-62a025de-2202-41ff-bb1f-ac45fde4d170",
							"my-bosh-alicloud-test",
							"alicloud-test-compilation-62a025de-2202-41ff-bb1f-ac45fde4d170",
							"my-bosh-alicloud-test-compilation-62a025de-2202-41ff-bb1f-ac45fde4d170"
						]
					}
				}
			],
			"context": {
				"director_uuid": "879e2edf-a9c4-4d2e-be8c-6b23dc530008",
				"request_id": "cpi-529789"
			}
		}`).ToBytes()
